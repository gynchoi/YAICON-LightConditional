...
class BaseOpts(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--concat_data', default=True, action='store_true') 
        ...
        self.parser.add_argument('--dir_int',     default=True, action='store_true')
        ...
        self.parser.add_argument('--s1_est_n',    default=True, action='store_true')
        self.parser.add_argument('--s1_est_d',    default=True,  action='store_true')
        self.parser.add_argument('--s1_est_i',    default=True,  action='store_true')
        ...
        self.parser.add_argument('--s2_est_n',    default=True,  action='store_true')
        self.parser.add_argument('--s2_est_i',    default=True, action='store_true')
        self.parser.add_argument('--s2_est_d',    default=True, action='store_true')
        ...
        #### Log Arguments ####
        self.parser.add_argument('--save_root',  default='/data')
        ...
        self.parser.add_argument('--save_split', default=True, action='store_true')
